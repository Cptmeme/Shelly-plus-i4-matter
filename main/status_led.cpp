...
// VERIFY: the Shelly Plus i4 status-LED GPIO is not published in the Tasmota
// template. GPIO0 is the common Shelly Plus LED pin and is used here as a
// best guess. Driving the wrong pin is harmless (it is only toggled as an
// output after boot), but confirm against your hardware for correct feedback.
// GPIO15 was the Shelly 1 Gen4 (ESP32-C6) LED and does not apply here.
